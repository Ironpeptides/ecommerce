      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div>
          ...
          <div className="mt-20 text-center">
            <button className="inline-flex items-center justify-center px-8 py-4 rounded-full bg-gradient-to-r from-blue-600 to-blue-600 text-white font-medium hover:from-blue-700 hover:to-blue-700 transition-all duration-300">
              Join Our Team
            </button>
          </div>
        </div>
